...
import co.sismomesh.core.domain.vo.GeoPoint
...
data class Node(val id: co.sismomesh.core.domain.vo.NodeId, val publicKey: ByteArray, val firstSeenMs: Long, val lastSeenMs: Long)
