...
**Código 100% generado** desde `protocol/proto/helius/v1/*.proto` con
...
- `../../../java/co/helius/core/protocol/v1/` — clases Java generadas (`--java_out`).
- Este directorio (`kotlin/co/helius/core/protocol/v1/`) — extensiones DSL de Kotlin (`--kotlin_out`), p. ej. `bundle { header = ...; status = emergencyStatus { ... } }`.
