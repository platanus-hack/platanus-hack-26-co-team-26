...
**Propósito:** Fakes compartidos (LoopbackFake, ScriptedFake, ReplayFake) y robots de test usados por todos los módulos Android.

**Dueño:** compartido — dueño de mantenimiento: Helmut.
